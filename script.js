        ...
        function drawArrow(context, fromX, fromY, toX, toY) {
            ...
            context.lineTo(toX - headLength * Math.cos(angle + Math.PI / 6), toY - headLength * Math.sin(angle + Math.PI / 6));
            context.strokeStyle = 'red'; context.lineWidth = 2; // Arrow width
            context.stroke();
        }
        ...
        function update() {
            ...
            if (isMoving) {
                ...
                if (clickedBody) {
                    ...
                    drawArrow(render.canvas.getContext('2d'), clickedBody.position.x, clickedBody.position.y, futureX, futureY);
                }
            }
        }
